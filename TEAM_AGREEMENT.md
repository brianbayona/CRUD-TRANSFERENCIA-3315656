...
* **Comunicación Oficial y Archivos:** Discord (canal `#general`)
* **Urgencias o bloqueos rápidos:** Discord (canal `#urgencias` o mensaje directo)
* **Gestión de Tareas y Código:** Estrictamente a través de los *Issues* y *Pull Requests* de GitHub. (No se revisa código por Discord).
